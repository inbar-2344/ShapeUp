...
from ..pipelines.ig2mv_sdxl_shapeup_pipeline_concat_mv import IG2MVSDXLPipeline
    ...
    def forward(
        ...
        **kwargs,
        ...
        with torch.no_grad():
            ...
            ref_hidden_states = {}
            # when extraction image latents for cross attention, use original conv_in
        ...
        original_shape_latents[original_mv_drop_mask] = 0.0
        # concatenate source mesh mv to noisy_latents
        noisy_latents = torch.cat([noisy_latents, original_shape_latents], dim=1)
