...
def main(args, extras) -> None:
    ...
    from shapeup_texture.systems.base import BaseSystem
    from shapeup_texture.utils.callbacks import (
        CodeSnapshotCallback,
        ConfigSnapshotCallback,
        CustomProgressBar,
        ProgressCallback,
    )
    from shapeup_texture.utils.config import ExperimentConfig, load_config
    from shapeup_texture.utils.core import find
    from shapeup_texture.utils.misc import get_rank, time_recorder
    from shapeup_texture.utils.typing import Optional
    ...
    if args.train:
        ...
        wandb_project = cfg.system.loggers.get("wandb", {}).get("project", "step1x-3d-texture")
        wandb_entity = cfg.system.loggers.get("wandb", {}).get("entity", None)
        wandb_logger = WandbLogger(
            save_dir=cfg.trial_dir,
            name=cfg.trial_dir,
