...
from shapeup_geometry.utils.ops import generate_dense_grid_points
from shapeup_geometry.utils.typing import *
from shapeup_geometry.utils.misc import get_rank
import torch.nn as nn

@shapeup_geometry.register("shape-autoencoder-system")
...
class ShapeAutoEncoderPipelineWrapper(nn.Module):
    # class Config(BaseSystem.Config):
    #     shape_model_type: str = None
    #     shape_model: dict = field(default_factory=dict)
