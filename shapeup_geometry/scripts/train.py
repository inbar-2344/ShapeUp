...
from shapeup_geometry.utils.callbacks import (
...
def main(args, extras) -> None:
    ...
    dm = shapeup_geometry.find(cfg.data_type)(cfg.data)
    system: BaseSystem = shapeup_geometry.find(cfg.system_type)(
    ...
    if args.train:
        ...
        loggers += [
            ...
            WandbLogger(save_dir=cfg.trial_dir, name=cfg.trial_dir, project=cfg.system.loggers.wandb.project, entity=cfg.system.loggers.wandb.entity)
        ] 
        rank_zero_only(
